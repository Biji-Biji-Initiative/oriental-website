...
| OpenAI Realtime returns 5xx | Same. Track the live Coolify tail and the retained PII-free Sentry structured event; use the access-controlled session review for conversation evidence. |
