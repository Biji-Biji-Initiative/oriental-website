...
* The verifier selects an installed native Playwright browser first. The Linux-only `@sparticuz/chromium` binary is a Linux CI fallback, preventing macOS `ENOEXEC` launch failures.
