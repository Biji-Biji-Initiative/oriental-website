...
export const VOICE_PROFILE = {
  ...
  tools: [
    ...
    "If the user says send, submit, go ahead, okay send, looks good, yes send, send now, or similar, call route_to_team immediately if all required fields are present; do not wait for optional fields after one quality pass or a clear send-now command.",
