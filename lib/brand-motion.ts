...
// Keep the M legible at the small dialog size. Higher density plus additive
// blending turns active-audio points into white blobs instead of clean pixels.
export const MEREKA_NEBULA_PARTICLE_COUNT = 1_200;
